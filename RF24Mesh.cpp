...
bool RF24Mesh::begin(uint8_t channel, rf24_datarate_e data_rate, rf24_pa_dbm_e power, uint32_t timeout)
{
...
int16_t RF24Mesh::getNodeIdForAddress(uint16_t address)
{
